 ...
 */
const descriptions: Record<Lang, (itemName: string, videoCount: number, releaseCount: number) => string> = {
    no: (itemName: string, videoCount: number, releaseCount: number) => {
    ...
    en: (itemName: string, videoCount: number, releaseCount: number) => {
        const usage = [
...
export function getEquipmentItemDescription(itemName: string, videoCount: number, releaseCount: number, lang: Lang): string {
