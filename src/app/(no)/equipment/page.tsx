...
export const metadata: Metadata = {
    title: 'Utstyr | Dehli Musikk',
    description: 'Utstyr jeg bruker under innspilling',
    alternates: {
        canonical: 'https://www.dehlimusikk.no/equipment/',
        languages: {
    ...
    openGraph: {
        title: 'Utstyr', url: 'https://www.dehlimusikk.no/equipment/',
        description: 'Utstyr jeg bruker under innspilling', locale: 'no_NO', alternateLocale: 'en_US'
    },
    twitter: { title: 'Utstyr', description: 'Utstyr jeg bruker under innspilling' }
};
...
export default function EquipmentPage() {
    const equipmentTypeItems = Object.keys(equipment).map((equipmentTypeKey, index) => ({
        ...
        position: index + 1,
        url: `https://www.dehlimusikk.no/equipment/${equipmentTypeKey}/`
    }));
    const jsonLd = {
        '@context': 'https://schema.org',
        '@type': 'ItemList',
        '@id': 'https://www.dehlimusikk.no/equipment/',
        name: 'Utstyr brukt av Dehli Musikk',
        itemListElement: equipmentTypeItems
    };

    const breadcrumbs = [{ name: 'Utstyr', path: '/equipment/' }];
