...
// Partials
const NavigationBar = prerenderedLoadable(() => import("./components/partials/NavigationBar"));
                        ...
                        <link
                            ...
                            title={
                                selectedLanguageKey === "en"
                                    ? "Subscribe to Dehli Musikk news"
                                    : "Abonner på Dehli Musikk nyheter"
                            }
                            href={`https://www.dehlimusikk.no/feed-${selectedLanguageKey}.rss`}
                        />
                    </Helmet>
                    <NavigationBar />
                    <div className={style.container}>
                        <main>
                            <Routes>
                                ...
                                <Route
                                    strict={true}
                                    path="/:selectedLanguage/portfolio/:releaseId/"
                                    element={<Portfolio />}
                                />
                                ...
                                <Route
                                    strict={true}
                                    path="/:selectedLanguage/videos/:videoId/video/"
                                    element={<Videos />}
                                />
                                ...
                                <Route
                                    strict={true}
                                    path="/:selectedLanguage/products/:productId/"
                                    element={<Products />}
                                />
                                ...
                                <Route
                                    strict={true}
                                    path="/equipment/:equipmentType/:equipmentId/"
                                    element={<Equipment />}
                                />
                                ...
                                <Route
                                    strict={true}
                                    path="/:selectedLanguage/equipment/:equipmentType/:equipmentId/"
                                    element={<Equipment />}
                                />
                                <Route
                                    strict={true}
                                    path="/:selectedLanguage/equipment/:equipmentType/"
                                    element={<Equipment />}
                                />
