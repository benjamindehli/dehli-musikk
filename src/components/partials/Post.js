...
// Template
const ListItemActionButtons = prerenderedLoadable(() =>
    import("components/template/List/ListItem/ListItemActionButtons")
);
const ListItemContent = prerenderedLoadable(() => import("components/template/List/ListItem/ListItemContent"));
const ListItemContentBody = prerenderedLoadable(() =>
    import("components/template/List/ListItem/ListItemContent/ListItemContentBody")
);
const ListItemContentHeader = prerenderedLoadable(() =>
    import("components/template/List/ListItem/ListItemContent/ListItemContentHeader")
);
const ListItemThumbnail = prerenderedLoadable(() => import("components/template/List/ListItem/ListItemThumbnail"));
        ...
        <React.Fragment>
            ...
            <ListItemContent fullscreen={fullscreen}>
                ...
                {post.link && fullscreen ? (
                    <ListItemActionButtons fullscreen={fullscreen}>{renderLink(post.link)}</ListItemActionButtons>
                ) : (
                    ""
                )}
            </ListItemContent>
