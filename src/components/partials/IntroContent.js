...
class IntroContent extends Component {
  render() {
    ...
    const norwegianContent = (<React.Fragment>
      ...
      <p>Har du en låt som skal spilles inn og mangler tangeter, ta gjerne kontakt på <a href={facebookLink} title="Dehli Musikks Facebook-side">Facebook</a> eller <a href={emailLink} title="Send Dehli Musikk en e-post">e-post</a>.</p>
    ...
    const englishContent = (<React.Fragment>
      ...
      <p>If you're recording a song and want some keyboard instrument tracks, feel free to contact me on  <a href={facebookLink} title="Dehli Musikk's Facebook page">Facebook</a> or <a href={emailLink} title="Send Dehli Musikk an email">email</a>.</p>
