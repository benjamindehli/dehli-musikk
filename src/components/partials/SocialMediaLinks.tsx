...
import { faFacebookF, faGithub, faInstagram, faYoutube, faVimeoV, faSoundcloud, faTumblr, faXTwitter } from "@fortawesome/free-brands-svg-icons";
 ...
 */
const SocialMediaLinks = ({ lang }: { lang: Lang }) => {
    return (
        <div className={style.socialMediaLinks}>
            ...
            <a
                href="https://www.instagram.com/benjamindehli/"
            ...
            <a
                href="https://youtube.com/@BenjaminDehli"
            ...
            <a
                href="https://vimeo.com/benjamindehli"
                title="Link to Vimeo page"
                aria-label="Link to Vimeo page"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <a
                href="https://soundcloud.com/benjamin-dehli"
                title="Link to SoundCloud page"
                aria-label="Link to SoundCloud page"
                target="_blank"
                rel="noopener noreferrer"
                className={style.soundcloud}
            >
                <FontAwesomeIcon icon={faSoundcloud} />
            </a>
            <a
                href="https://benjamindehli.tumblr.com/"
                title="Link to Tumblr page"
                aria-label="Link to Tumblr page"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <a
                href="https://twitter.com/BenjaminDehli"
            ...
            <a
                href="https://github.com/benjamindehli"
            ...
            <a
                href="https://store.dehlimusikk.no/"
                title="Link to Gumroad page"
                aria-label="Link to Gumroad page"
                target="_blank"
                rel="noopener noreferrer"
            ...
            <a
                ...
                title="Link to Ko-fi page"
                aria-label="Link to Ko-fi page"
                target="_blank"
                rel="noopener noreferrer"
