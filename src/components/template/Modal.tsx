...
const Modal = ({ isTheaterMode = false, maxWidth = "none", lang = "no", listPath, arrowLeftLink, arrowRightLink, children }: ModalProps) => {
    const overlayClasses = [style.postModalOverlay, isTheaterMode && style.theaterMode].filter(Boolean).join(" ");
    const contentClasses = [style.postModalContent, isTheaterMode && style.theaterMode].filter(Boolean).join(" ");
