...
const ASSET_EXTENSIONS = new Set(["jpg", "jpeg", "png", "webp", "avif", "svg", "ico", "gif", "woff", "woff2", "ttf", "otf", "json"]);
...
function run() {
    ...
    missing
        .slice(0, 15)
        .forEach(({ kind, assetPathname, page }) => console.log(`   missing: ${assetPathname}\n            named by ${kind} on ${page}`));
